...
const HERO_SLIDES = [
  {
    ...
    tag: 'AFRIFOOD BASKET',
    titleLine1: 'The Taste of Home,',
    titleLine2: 'Delivered to Germany.',
    sub: 'AfriFood Basket brings authentic West African food sourced directly from farms to your door — anywhere in Germany.',
  ...
  },
  {
    ...
    sub: 'Every bag of egusi, stockfish, Ofada rice and palm oil is personally inspected and quality-checked before it reaches your kitchen.',
    cta: 'BROWSE PRODUCTS',
    category: 'all',
  },
  {
    bg: 'https://images.unsplash.com/photo-1543323717-89c8218ebbdb?w=1600&q=85',
    tag: 'GERMANY-WIDE DELIVERY',
    titleLine1: 'Vacuum Sealed,',
    titleLine2: 'Germany-Wide.',
    sub: 'Clean, secure packaging and DHL Express shipping to Berlin, Hamburg, Munich, Frankfurt, Cologne and every corner of Germany.',
    cta: 'ORDER TODAY',
    category: 'all',
  },
];
